...
const Projects = () => {
  ...
  const [done, setDone] = useState([
    ...
    {id: "1", name: "Insurances site", img: winsu, desc: "A site for a company called Worthinsurance. Descriptions and packets of every insurance the company offers", delay: 1500, liveSite: "https://worthinsurance.netlify.app", source: "https://github.com/Bill-1991/insurances-site/tree/main/src", skills: ["Html", "Css", "Javscript", "React"], flip: false},
