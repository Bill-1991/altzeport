...
const Projects = () => {
  ...
  const [done, setDone] = useState([
    ...
    {id: "1", name: "E-commerce", img: ecom, desc: "Responsive e-commerce site for anime.(Back-end is down at the moment)", delay: 1000, liveSite: "https://splendid-granita-8f1e4f.netlify.app/", source: "https://github.com/Bill-1991/bill-commerce/tree/master", skills: ["Html", "Css", "Bootstrap", "Javascript", "React", "Node", "MySQL", "React-Router", "Anime API"], flip: false},
    {id: "2", name: "Insurances site", img: winsu, desc: "A site for a company called Worthinsurance. Descriptions and packets of every insurance the company offers", delay: 1500, liveSite: "https://worthinsurance.netlify.app", source: "https://github.com/Bill-1991/insurances-site/tree/main/src", skills: ["Html", "Css", "Javscript", "React"], flip: false},
    {id: "3", name: "Multistep form", img: stepForm, desc: "Multistep Form. (Not fully constructed in rsponsiveness. A project by frontendmentor.io!)", delay: 1500, liveSite: "https://warm-sfogliatella-1b0cc2.netlify.app/", source: "https://github.com/Bill-1991/multistep-form-frontmentor/tree/master/src", skills: ["Html", "Css", "Javscript", "React"], flip: false},
    {id: "4", name: "Tic Tac Toe", img: "", desc: "Tic Tac Toe minigame. (Not fully constructed. There's no live site on this only the source code. VScom mode only does random moves)", delay: 1500, livesite: "", source: "https://github.com/Bill-1991/Tic-tac-toe", skills: ["Html", "Css", "Javscript"], flip: false}])  
