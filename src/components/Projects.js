...
const Projects = () => {
  ...
  const [done, setDone] = useState([
    {id: "0", name: "Dynamic styled qrCode generator", img: qr, desc: "Style your qrCode as you like and select between redirection to a website or to a Vcard", delay: 500, liveSite: "https://demo-project1-lhwe.onrender.com", source: "https://github.com/Bill-1991/Demo-project1", skills: ["Html", "Css", "React", "Node.js", "MongoDB"], flip: false},
    {id: "1", name: "Companies Catalogue", img: cat, desc: "A catalogue for companies to display their products", delay: 1000, liveSite: "https://demo-project2.onrender.com", source: "https://github.com/Bill-1991/Demo-project2", skills: ["Html", "Css", "React", "json server"], flip: false},
